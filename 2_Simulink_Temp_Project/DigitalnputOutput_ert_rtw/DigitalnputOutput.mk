###########################################################################
## Makefile generated for component 'DigitalnputOutput'. 
## 
## Makefile     : DigitalnputOutput.mk
## Generated on : Sun Mar 17 04:38:38 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DigitalnputOutput.elf
...
PRODUCT_NAME              = DigitalnputOutput
MAKEFILE                  = DigitalnputOutput.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/brbar/Documents/MATLAB/MBD_Diploma/Smulink_Temp_Project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DigitalnputOutput.elf
...
DEFINES_STANDARD = -DMODEL=DigitalnputOutput -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/DigitalnputOutput_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DigitalnputOutput_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DigitalnputOutput_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DigitalnputOutput.o : $(START_DIR)/DigitalnputOutput_ert_rtw/DigitalnputOutput.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DigitalnputOutput_data.o : $(START_DIR)/DigitalnputOutput_ert_rtw/DigitalnputOutput_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DigitalnputOutput_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
