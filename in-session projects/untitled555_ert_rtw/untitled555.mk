###########################################################################
## Makefile generated for component 'untitled555'. 
## 
## Makefile     : untitled555.mk
## Generated on : Mon Mar 18 15:29:44 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/untitled555.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/untitled555.elf
...
DEFINES_STANDARD = -DMODEL=untitled555 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o untitled555.o untitled555_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/untitled555_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/untitled555_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/untitled555_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/untitled555_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


untitled555.o : $(START_DIR)/untitled555_ert_rtw/untitled555.c
	$(CC) $(CFLAGS) -o "$@" "$<"


untitled555_data.o : $(START_DIR)/untitled555_ert_rtw/untitled555_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
