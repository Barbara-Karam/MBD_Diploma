...
void rt_OneStep(void)
{
   ...
   */
  untitled555_SetEventsForThisBaseStep(eventFlags);
  ...
  currentTime = (extmodeSimulationTime_T) ((untitled555_M->Timing.clockTick0 * 1)
    + 0)
    ;
  untitled555_step0();
  ...
  if (need2runFlags[1]) {
    ...
    {
     case 1 :
      currentTime = (extmodeSimulationTime_T) ((untitled555_M->Timing.clockTick1
        * 100) + 0)
        ;
      untitled555_step1();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(untitled555_M, 0);
  ...
  untitled555_initialize();
  cli();
  sei ();

  /* External Mode initialization */
  errorCode = extmodeInit(untitled555_M->extModeInfo, &rtmGetTFinal
    (untitled555_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(untitled555_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(untitled555_M);
