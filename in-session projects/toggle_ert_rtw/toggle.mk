###########################################################################
## Makefile generated for component 'toggle'. 
## 
## Makefile     : toggle.mk
## Generated on : Mon Mar 18 03:44:06 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/toggle.elf
...
START_DIR                 = C:/Users/brbar/DOCUME~1/MATLAB/MBD_DI~1/IN-SES~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/toggle.elf
...
DEFINES_STANDARD = -DMODEL=toggle -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o toggle.o toggle_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/toggle_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/toggle_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/toggle_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/toggle_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


toggle.o : $(START_DIR)/toggle_ert_rtw/toggle.c
	$(CC) $(CFLAGS) -o "$@" "$<"


toggle_data.o : $(START_DIR)/toggle_ert_rtw/toggle_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
