...
void rt_OneStep(void)
{
   ...
   */
  toggle_SetEventsForThisBaseStep(eventFlags);
  ...
  currentTime = (extmodeSimulationTime_T) ((toggle_M->Timing.clockTick0 * 1) + 0)
    ;
  toggle_step0();
  ...
  if (need2runFlags[1]) {
    ...
    {
     case 1 :
      currentTime = (extmodeSimulationTime_T) ((toggle_M->Timing.clockTick1 *
        100) + 0)
        ;
      toggle_step1();
...
int main(void)
{
  ...
  errorCode = extmodeInit(toggle_M->extModeInfo, &rtmGetTFinal(toggle_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(toggle_M, true);
    }
  }
