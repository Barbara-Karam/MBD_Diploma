###########################################################################
## Makefile generated for component 'untitleddddddddddddddd'. 
## 
## Makefile     : untitleddddddddddddddd.mk
## Generated on : Sat Mar 09 00:09:53 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/untitleddddddddddddddd.elf
...
SLIB_PATH                 = C:/Users/brbar/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~2/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/untitleddddddddddddddd.elf
...
DEFINES_STANDARD = -DMODEL=untitleddddddddddddddd -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o untitleddddddddddddddd.o untitleddddddddddddddd_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


untitleddddddddddddddd.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/untitleddddddddddddddd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


untitleddddddddddddddd_data.o : $(START_DIR)/untitleddddddddddddddd_ert_rtw/untitleddddddddddddddd_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
