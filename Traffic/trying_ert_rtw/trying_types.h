...
#ifndef RTW_HEADER_trying_types_h_
#define RTW_HEADER_trying_types_h_
#include "rtwtypes.h"
...
typedef struct tag_AYWgtFscQm3mLUJYb3A20C codertarget_arduinobase_blo_g_T;

#endif                             /* typedef_codertarget_arduinobase_blo_g_T */

/* Parameters (default storage) */
typedef struct P_trying_T_ P_trying_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_trying_T RT_MODEL_trying_T;

#endif                                 /* RTW_HEADER_trying_types_h_ */
