###########################################################################
## Makefile generated for component 'RC'. 
## 
## Makefile     : RC.mk
## Generated on : Fri Mar 29 23:57:46 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RC.elf
...
START_DIR                 = C:/Users/brbar/Documents/MATLAB/MBD_Diploma/Arduino_Lab3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RC.elf
...
DEFINES_STANDARD = -DMODEL=RC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o RC.o RC_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/RC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/RC_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
RC.o : $(START_DIR)/RC_ert_rtw/RC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RC_data.o : $(START_DIR)/RC_ert_rtw/RC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/RC_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
