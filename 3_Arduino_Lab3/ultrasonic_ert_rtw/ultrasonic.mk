...
## Generated on : Thu Mar 28 16:34:59 2024
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/ultrasonic_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
OBJS = MW_arduino_digitalio.o MW_Ultrasonic.o ultrasonic.o ultrasonic_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/ultrasonic_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ultrasonic_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ultrasonic_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ultrasonic.o : $(START_DIR)/ultrasonic_ert_rtw/ultrasonic.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ultrasonic_data.o : $(START_DIR)/ultrasonic_ert_rtw/ultrasonic_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
