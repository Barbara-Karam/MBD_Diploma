...
void irrigation_step(void)
{
   ...
   *  Outport: '<Root>/Out1'
   *  SignalConversion generated from: '<S4>/RED LED (Error)'
   */
  rtY.Out1 = 0.0;
  ...
  rtY.waterpump = rtDW.Compare_k;

  /* Outport: '<Root>/Out2' */
  rtY.Out2 = rtDW.Compare;
...
void irrigation_initialize(void)
{
  /* Registration code */
  {
    /* Setup solver object */
